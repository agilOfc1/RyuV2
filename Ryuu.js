...
Badmin: 'Bot Harus Jadi Admin Kalo Mau Menggunakan Fiturnya', 
        ...
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `Made By ${ownername}`, orderTitle: 'AGIL', sellerJid: '0@s.whatsapp.net'} } }
//═════════[ VERIFY ]══════════/
//═════════[ Button ]══════════//
...
menu =
`╭─❒ 「 𝗗𝗢𝗡𝗔𝗦𝗜 」
│⬡ 𝘿𝙖𝙣𝙖 : https://saweria.co/donateagilcodex
│⬡ 𝙊𝙫𝙤 : https://saweria.co/donateagilcodex
│⬡ 𝙂𝙤𝙥𝙖𝙮 : https://saweria.co/donateagilcodex
╰─❒
...
╰─❒
╭─❒
│⬡ 𝙔𝙤𝙪𝙩𝙪𝙗𝙚 : https://youtube.com/c/RyuukaBotz
...
🌐 𝙔𝙤𝙪𝙩𝙪𝙗𝙚 :
https://m.youtube.com/channel/UCnNa_6p429Evpp9mq7B8LSA
